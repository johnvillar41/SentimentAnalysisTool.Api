...
namespace SentimentAnalysisTool.Services.Services.Interfaces
{
    public interface ISlangRecordsService
    {
        ...
        Task<bool> AddSlangRecordAsync(IEnumerable<SlangRecordModel> slangRecord, int corpusTypeId, string connectionString);
        ...
        Task<IEnumerable<SlangRecordModel>> FetchSlangRecordAsync(int? corpusTypeId, string connectionString);
    }
}
